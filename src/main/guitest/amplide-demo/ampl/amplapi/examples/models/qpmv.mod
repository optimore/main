...
set stockrun  ordered;	# Stocks used for this run
set stockopall ordered; # Stocks which had more than 0.5 weight	
set stockrun2;			# User for assignment in the script

param ncard default 10;				# Maximum cardinality of portfolio
param averret{stockall};			# Average return of each stock
param covar{stockall,stockall};		# Covariane matrix
param cutoffl default 0.0001;		# Lower cutoff (weight>this ->stock out)
param cutoffh{stockall} default 1;	# High cutoff (weight>this -> stock in)
