classdef C6_20 < handle
    % C6_20 Intensification phase: both long and short steps possible
    % Dynamic weights update after 10 iterations
    ...
    methods
        ...
        % Constructor:
        function obj = C6_20(resultfile,logfile,nrTasks)
            name = class(obj);
