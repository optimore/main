classdef SimpleMoveOneTaskC < handle
    ...
    methods        
        ...
        % Constructor:
        function obj = SimpleMoveOneTaskC(resultfile,logfile,nrTasks)
        ...
        function [data,obj] = SetStartingSolution(obj,data)
